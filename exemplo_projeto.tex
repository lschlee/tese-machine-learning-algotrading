...
\chapter{Pré-processamento e Base de Dados do Modelo}    
    ...
    \chapter{Resultados e Discussões}
        ...
        \begin{figure}[h!]
            ...
            \includegraphics[width=12.1cm]{performance-logreg.png}
            \centering
        \end{figure}
        ...
        \begin{figure}[h!]
            ...
            \includegraphics[width=12.1cm]{mlp-performance.png}
            \centering
        \end{figure}
  ...
  \chapter{Conclusões}
    ...
    \section{Conclusões Gerais}
        ...
        \paragraph{}Ao aplicar a estratégia definida para o caso de uso real das ações da Petrobrás (PETR4), foi possível observar que, mesmo para um grupo mínimo de dias de treino, o modelo apresentou uma precisão considerávelmente maior do que um modelo aleatório. Apesar do caso de uso não ter apresentado o requisito mínimo de precisão para garantir o lucro, já é possível a utilização do presente modelo para uma estratégia mais arrojada puramente baseada em aprendizado de máquina.
