...
\chapter{Pré-processamento e Base de Dados do Modelo}    
    ...
    \chapter{Resultados e Discussões}
        ...
        \paragraph{}Ao observar a evolução das precisões e realocações, pode-se perceber um ruído muito maior no MLP. A curva traçada para ambas as medidas pela regressão é muito mais suave, fator que indica maior estabilidade e, portanto, confiabilidade e poder preditivo do algoritmo.
...
\chapter{Revisão Bibliográfica}
  ...
  \appendix 
  \chapter{Algumas Demonstrações}\label{cap:params}
\end{document}
%% 
%%
